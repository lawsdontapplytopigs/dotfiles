...
theme.bg_normal     = bg_light --titlebar unfocused
theme.bg_focus      = purple
theme.bg_urgent     = purple
theme.bg_minimize   = bg_light
theme.bg_systray    = bg_light


-- these don't matter because I turned them off
-- they're basically the text on windows titlebars
